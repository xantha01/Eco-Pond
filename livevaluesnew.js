...
onValue(dbRef, (snapshot) => {
  if (snapshot.exists()) {
    ...
    document.getElementById("ammoniaval").innerText = data.airQuality;
    document.getElementById("tdsval").innerText = data.tds;
    document.getElementById("tempval").innerText = data.temperature;
    document.getElementById("turbidityval").innerText = data.turbidity;
    document.getElementById("tankval").innerText = data.waterLevelPercent;
    document.getElementById("water").style.height = data.waterLevelPercent + "%";
